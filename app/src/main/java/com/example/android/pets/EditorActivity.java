...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (currentPetUri != null) {
            ...
            // Tell Android to Redraw the options menu so changes in <onPrepareOptionsMenu>
            //  could take effect.
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case android.R.id.home:
                ...
                showUnsavedChangedDialog(discardButtonOnClickListener);
                return true;
    ...
    private void showUnsavedChangedDialog(DialogInterface.OnClickListener discardButtonOnClickListener) {
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        builder.setMessage("Discard your changes and quit editing?");
        builder.setPositiveButton("Discard", discardButtonOnClickListener);
    ...
    public void savePet() {
        ...
        // Safety Checks for weight Integer Extraction
        ...
        // CREATE NEW PET LOGIC
        if (currentPetUri == null) {
            if (!(TextUtils.isEmpty(nameString) && TextUtils.isEmpty(breedString)
                    && TextUtils.isEmpty(weightString) && mGender == PetEntry.GENDER_UNKNOWN)) {
                Uri newUri = getContentResolver().insert(PetEntry.CONTENT_URI, values);
                if (newUri == null) {
                    Toast.makeText(getApplicationContext(), R.string.added_error, Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(getApplicationContext(), R.string.added_succefully, Toast.LENGTH_SHORT).show();
                    return;
                }
            } else {
        ...
        if (currentPetUri != null) {
            if (!(TextUtils.isEmpty(nameString) && TextUtils.isEmpty(breedString)
                ...
                if (updatedRows == 0) {
                    Toast.makeText(getApplicationContext(), R.string.updated_error, Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(getApplicationContext(), R.string.updated_succefully, Toast.LENGTH_SHORT).show();
                }
            } else {
                Toast.makeText(getApplicationContext(), R.string.empty_fields_error, Toast.LENGTH_SHORT).show();
            }
    ...
    private void deletePet() {
        int result = getContentResolver().delete(currentPetUri, null, null);
        if (currentPetUri != null) {
            if (result != 0) {
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        if (cursor.moveToFirst()) {
            ...
            /**
             * Check if the following disabled snippet will cause bugs..
             */
            /*switch (petGender) {
